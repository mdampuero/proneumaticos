...
class Model_DBTable_Tbranch extends Zend_Db_Table_Abstract {

    protected $_name = 'sg_tbranch';
    protected $names = 'tb_name';
    protected $primary = 'tb_id';
    protected $deleted = 'tb_deleted';
    protected $status = 'tb_status';
    protected $modified = 'tb_modified';
    protected $created = 'tb_created';
    protected $defultSort = 'tb_name';
