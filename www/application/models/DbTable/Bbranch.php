...
class Model_DBTable_Bbranch extends Zend_Db_Table_Abstract {

    protected $_name = 'sg_bbranch';
    protected $names = 'bb_name';
    protected $primary = 'bb_id';
    protected $deleted = 'bb_deleted';
    protected $status = 'bb_status';
    protected $modified = 'bb_modified';
    protected $created = 'bb_created';
    protected $defultSort = 'bb_name';
