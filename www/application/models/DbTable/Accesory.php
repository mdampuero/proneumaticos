...
class Model_DBTable_Accesory extends Zend_Db_Table_Abstract {

    protected $_name = 'sg_accesory';
    protected $names = 'ac_name';
    protected $primary = 'ac_id';
    protected $deleted = 'ac_deleted';
    protected $status = 'ac_status';
    protected $modified = 'ac_modified';
    protected $created = 'ac_created';
    protected $defultSort = 'ac_name';
