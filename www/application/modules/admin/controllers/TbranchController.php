...
class Admin_TbranchController extends Zend_Controller_Action {

    var $fields = array();
    var $actions = array();
    var $options = array();
    var $singular = "Llanta";
    var $plural = "todas las LLantas";
    var $messageDelete = "¿Esta seguro que desea eliminar esta LLanta?";
    var $title = "Repuestos / LLantas";
    ...
    public function init() {
        try {
            ...
            //SEND DATE VIEW
            $this->fields = array(
                array('field' => 'tb_id', 'label' => 'ID', 'list' => true, 'class' => 'id', 'order' => true),
                array('field' => 'tb_name', 'label' => 'Nombre', 'required' => 'required', 'search' => true, 'order' => true, 'list' => true),
            );
            ...
            $this->model = new Model_DBTable_Tbranch();
