...
class Admin_BbranchController extends Zend_Controller_Action {

    var $fields = array();
    var $actions = array();
    var $options = array();
    var $singular = "Batería";
    var $plural = "todas las Baterías";
    var $messageDelete = "¿Esta seguro que desea eliminar esta Batería?";
    var $title = "Repuestos / Baterías";
    ...
    public function init() {
        try {
            ...
            $this->model = new Model_DBTable_Bbranch();
