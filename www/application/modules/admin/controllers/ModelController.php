...
class Admin_ModelController extends Zend_Controller_Action {
    ...
    var $messageDelete = "¿Esta seguro que desea eliminar este Modelo?";
    var $title = "Vehículos / Modelos";
    ...
    public function indexAction() {
        try {
            $this->view->filter = array(
                'mo_br_id' => array('label' => 'Marca', 'data' => $this->branch->showAll(), 'id' => 'br_id', 'value' => 'br_name')
            );
            //SAVE MASIVE
            //SAVE MASIVE
