...
class Admin_CbranchController extends Zend_Controller_Action {

    var $fields = array();
    var $actions = array();
    var $options = array();
    var $singular = "Neumático";
    var $plural = "todos los Neumáticos";
    var $messageDelete = "¿Esta seguro que desea eliminar este Neumático?";
    var $title = "Repuestos / Neumáticos";
    ...
    public function init() {
        try {
            ...
            $this->model = new Model_DBTable_Cbranch();
